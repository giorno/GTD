...
class _uicmp_stuff_fold extends \io\creat\chassis\uicmp\fold
{
	 ...
	 *
	 * @param <_uicmp_comp> $parent reference to parent component
	...
	public function  generateJs ( )
	{
		...
		/*if ( !self::$initialized )
		{
			$requirer->call( _uicmp_layout::RES_JSPLAIN, 'var ' . $this->getJsVar( )  . ' = new _uicmp_stuff_folds( \'' . self::$url . '\', ' . $this->generateJsArray( self::$params ) . ' );' );
			self::$initialized = TRUE;
		}*/
	...
	public function getJsVar ( )
	{
		...
		return self::getJsName( $this->getRequirer( ) );
	}
